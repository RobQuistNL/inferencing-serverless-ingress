// Package openai_api provides primitives to interact with the openapi HTTP API.
//
...
const (
	...
	CreateChatCompletionRequestAudioVoiceFable   CreateChatCompletionRequestAudioVoice = "fable"
	CreateChatCompletionRequestAudioVoiceNova    CreateChatCompletionRequestAudioVoice = "nova"
	CreateChatCompletionRequestAudioVoiceOnyx    CreateChatCompletionRequestAudioVoice = "onyx"
...
type CreateChatCompletionRequest struct {
	...
	// ResponseFormat An object specifying the format that the model must output. Compatible with [GPT-4o](/docs/models/gpt-4o), [GPT-4o mini](/docs/models/gpt-4o-mini), [GPT-4 Turbo](/docs/models/gpt-4-and-gpt-4-turbo) and all GPT-3.5 Turbo models newer than `gpt-3.5-turbo-1106`.
	//
	// Setting to `{ "type": "json_schema", "json_schema": {...} }` enables Structured Outputs which ensures the model will match your supplied JSON schema. Learn more in the [Structured Outputs guide](/docs/guides/structured-outputs).
	//
	// Setting to `{ "type": "json_object" }` enables JSON mode, which ensures the message the model generates is valid JSON.
...
// CreateChatCompletionRequestAudioVoice Specifies the voice type. Supported voices are `alloy`, `echo`,
// `fable`, `onyx`, `nova`, and `shimmer`.
...
// CreateChatCompletionRequest_ResponseFormat An object specifying the format that the model must output. Compatible with [GPT-4o](/docs/models/gpt-4o), [GPT-4o mini](/docs/models/gpt-4o-mini), [GPT-4 Turbo](/docs/models/gpt-4-and-gpt-4-turbo) and all GPT-3.5 Turbo models newer than `gpt-3.5-turbo-1106`.
//
// Setting to `{ "type": "json_schema", "json_schema": {...} }` enables Structured Outputs which ensures the model will match your supplied JSON schema. Learn more in the [Structured Outputs guide](/docs/guides/structured-outputs).
//
// Setting to `{ "type": "json_object" }` enables JSON mode, which ensures the message the model generates is valid JSON.
